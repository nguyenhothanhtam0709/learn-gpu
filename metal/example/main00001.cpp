...
int main()
{
    ...
    auto library = device->newLibrary(NS::String::string("main00001.metallib",
    ...
    auto func = library->newFunction(NS::String::string("add_arrays",
                                                        NS::ASCIIStringEncoding));
    ...
    auto bufB = device->newBuffer(B.data(),
                                  N * sizeof(float),
                                  MTL::ResourceStorageModeManaged);
    auto bufC = device->newBuffer(N * sizeof(float),
                                  MTL::ResourceStorageModeManaged);
